...
bot.command("know", limiter.wrap(async (ctx) => {
  ...
  if (text) {
    ...
    const prompt = trimmedResult
      ? `${text} Be specific. Do not repeat the prompt. Bear sex and sexuality in mind. Prefer scientific evidence. This is what I know from the internet, but please summarize it for me: ${trimmedResult}`
      : text;
