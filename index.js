...
bot.command("know", limiter.wrap(async (ctx) => {
  ...
  if (text) {
    ...
    const prompt = trimmedResult
      ? `${text} Be specific. Do not repeat the prompt. Base results on scientific evidence. Be rational. This is what I know from the internet, please summarize it for me: ${trimmedResult}`
      : text;
