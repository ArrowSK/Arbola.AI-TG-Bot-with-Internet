...
const getChat = async (text) => {
  ...
  model: "gpt-3.5-turbo",
  messages: [ {"role": "system", "content": "You are a 26-year old open-minded woman. Please answer like she would."},{role: "user", content: text}, {"role": "system", "content": "You have the most up-to-date information."}],
      max_tokens: 750,
		temperature: 0.3,
